...
|:--------  |:------- |:--------------- |
| Anticipate Need | Right vehicles are not in the right place | <ul> <li>Right vehicle type at right location/time [Invenotry Management](diagram/CA-Management-InvMgmt.jpeg) <li>Proactive fleet repositioning <li>Reduced idle time and wasted resources <li>[Data Pipe Line](diagram/deman_data_pipeline.md)<ul>|
